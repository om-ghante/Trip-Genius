    ...
    <>
      <div className='mx-auto mt-4 md:mt-6 lg:mt-0 mb-8'>
        ...
        <div className='flex-1 md:w-1/2 rounded-lg p-1 ml-0 md:ml-0 lg:ml-9'>
            ...
            <Typography variant="h3" color="blue-gray" className="mb-1 md:mb-2 lg:mb-4 uppercase text-left text-1xl md:text-2xl lg:text-3xl font-bold tracking-wide leading-tight">
                Organize Your Trip with Gemini ✨
            </Typography>
            <Typography variant="h1" color="blue-gray" className="mb-0 uppercase text-left text-2xl md:text-4xl lg:text-5xl font-bold tracking-wide leading-tight">
                No Hefty Cost.
            </Typography>
            <Typography variant="h1" color="blue-gray" className="mb-1 md:mb-2 lg:mb-4 uppercase text-left text-2xl md:text-4xl lg:text-5xl font-bold tracking-wide leading-tight">
                No Stress.
            </Typography>
            <Typography color="gray" variant="paragraph" className="mb-6 text-left text-sm md:text-base lg:text-lg">
